...
You can run the application with `make run oedokumaci-testing [ARGS...]`.
...
If you work in VSCode, we provide [an action to configure VSCode](https://oedokumaci.github.io/copier-uv/work/#vscode-setup) for the project.
